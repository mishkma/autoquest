...
var I18N = {
  en: {
    ...
    implementQuestion: 'Write and run your own solution in real Python — what did it actually print?',
    implementPlaceholder: 'Paste the exact output your program printed, line by line',
    implementCheck: '🔍 Check my answer',
    implementExactTitle: '<b>Correct! 🎯</b>', implementExactBody: 'Your solution produces the right result — task complete.',
    implementWrongTitle: '<b>Not quite right</b>',
    implementWrongBody: 'The correct output is:<br><code>{actual}</code><br>Go back to your code, figure out where it diverges, fix it, run it again, and paste the new output.',
  ...
  ru: {
    ...
    musicCardTitle: 'МУЗЫКА',
    musicMuteOn: 'Выключить',
    musicMuteOff: 'Включить',
    ...
    implementQuestion: 'Напишите и запустите собственное решение в настоящем Python — что оно напечатало?',
    implementPlaceholder: 'Вставьте точный вывод вашей программы, построчно',
    implementCheck: '🔍 Проверить мой ответ',
    implementExactTitle: '<b>Верно! 🎯</b>', implementExactBody: 'Ваше решение даёт правильный результат — задача выполнена.',
    implementWrongTitle: '<b>Пока не то</b>',
    implementWrongBody: 'Правильный вывод:<br><code>{actual}</code><br>Вернитесь к своему коду, найдите, где расхождение, исправьте, запустите снова и вставьте новый вывод.',
